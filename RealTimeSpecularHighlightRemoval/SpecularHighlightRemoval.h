...
private:
	...
	int round(int x);
#ifdef REMOVE_SPECULAR_HIGHLIGHT_USING_CUDA 
	cv::cuda::GpuMat deviceOriginalImage, deviceDiffuseImage, deviceSpecularImage, deviceMinimumImage, deviceMaximumImage, deviceRangeImage, deviceMaskImage;
	cv::cuda::GpuMat deviceMinimumChromaticityImage, deviceMaximumChromaticityImage, deviceClusterImage, deviceRatioImage;
